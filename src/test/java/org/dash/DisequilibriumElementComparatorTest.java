...
public class DisequilibriumElementComparatorTest extends TestCase {
	...
	public void testBaseComparison() {
		BaseBCDisequilibriumElement element1 = new BaseBCDisequilibriumElement("HLA-B*52:01", "HLA-C*04:01", "1", "Some note");

		BaseBCDisequilibriumElement element2 = new BaseBCDisequilibriumElement("HLA-B*07:01", "HLA-C*01:01", "2", "Another note");
