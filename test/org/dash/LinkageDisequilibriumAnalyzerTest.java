...
public class LinkageDisequilibriumAnalyzerTest extends TestCase {	
	...
	public void testLinkageReportingExamples() {
		LinkageDisequilibriumAnalyzer.main(new String[] {"resources/test/contrivedExamples.txt", "resources/test/fullyQualifiedExample.txt", "resources/test/strictExample.txt", "resources/test/shorthandExamples.txt"});
	}
	...
	public void testLinkageReportingInlineGLString() throws IOException {
		System.setProperty(Frequencies.FREQUENCIES_PROPERTY, "nmdp");
